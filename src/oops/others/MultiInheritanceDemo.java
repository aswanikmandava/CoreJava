...
class Wheeler4 {  // Base class

    private int model;  // Common features of all cars
    private String manufacturer;

    public Wheeler4(int model, String manufacturer) {  // Constructor
        this.model = model;
...
class Elantra extends Wheeler4 implements IsSedan {  // Elantra is a Car and is a Sedan also
